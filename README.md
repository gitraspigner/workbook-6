# Year Up United / Pluralsight - Java Workbook 6 (Ravi's Solutions)
...
| --- | --- |
| ![Status](https://img.shields.io/badge/status-active-brightgreen) | 11/04/2025 - XX/XX/2025|
<!-- Inactive:  https://img.shields.io/badge/status-inactive-lightgrey -->
<!-- Active:    https://img.shields.io/badge/status-active-brightgreen -->

### 📝 Description
Contains a collection of my starter-level java exercise solutions from week 7 (workbook 6). <br>
